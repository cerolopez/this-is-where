...
const Settings = () => {
    ...
    const [profileAlertVisibility, setProfileAlertVisibility] =
        useState("none");
    ...
    async function updateProfileVisibility() {
        ...
        if (!resJson.success) {
            setProfileAlertMsg(
                "There was an issue and your profile privacy could not be updated at this time."
            );
    ...
    if (authenticated && loadedUserInfo) {
        return (
            <>
                ...
                <div className="row header-row loginHeader">
                    <PageSidebar></PageSidebar>
                </div>
                                        ...
                                        <div className="card userSetting">
                                            <div className="card-body">
                                                ...
                                                <p className="card-text">
                                                    ...
                                                    below only if you are
                                                    absolutely sure - this will
                                                    permanently delete your
                                                    account and all of your
                                                    posts!
                                                </p>
                                                <form
                                                    ...
                                                    method="post"
                                                >
                                                    <button className="btn btn-outline-dark action-btn deleteButton">
                                                        Delete Account
                                                    </button>
                                                </form>
                                            </div>
                    ...
                    >
                        <div className="container">
                            ...
                            <div className="row d-flex">
                                ...
                                <div className="col-md-6">
                                    <Alert
                                        alert_type={profileAlertType}
                                        display={profileAlertVisibility}
                                    >
                                        {profileAlertMsg}
                                    </Alert>
                                    <h2>Edit Profile</h2>
                                    ...
                                    >
                                        ...
                                        <div className="form-check form-switch">
                                            <input
                                                ...
                                                checked={
                                                    profileHidden ? true : false
                                                }
                                                type="checkbox"
                                                role="switch"
                                                id="toggleProfileVisibility"
                                                onChange={() => {
                                                    setProfileHidden(
                                                        !profileHidden
                                                    );
                                            ...
                                            <label
                                                ...
                                                htmlFor="toggleProfileVisibility"
                                            >
                                                {profileHidden
                                                    ? "Private"
                                                    : "Public"}
